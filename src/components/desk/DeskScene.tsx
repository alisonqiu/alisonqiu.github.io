...
export default function DeskScene({ children }: DeskSceneProps) {
  return (
    <div className="wood-desk wood-grain relative flex h-full w-full items-center justify-center overflow-hidden">
      {/* Sunlight */}
      <div
